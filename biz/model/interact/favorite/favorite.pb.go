...
type DouyinFavoriteListResponse struct {
	...
	StatusCode *int32          `protobuf:"varint,1,req,name=status_code,json=statusCode" json:"status_code,required" form:"status_code,required" query:"status_code,required"` // 状态码，0-成功，其他值-失败
	StatusMsg  *string         `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg" json:"status_msg,omitempty" form:"status_msg" query:"status_msg"`                        // 返回状态描述
	VideoList  []*common.Video `protobuf:"bytes,3,rep,name=video_list,json=videoList" json:"video_list,omitempty" form:"video_list" query:"video_list"`                        // 用户点赞视频列表
}
...
var file_favorite_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8d, 0x01, 0x0a, 0x1d, 0x64, 0x6f,
	0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x6c, 0x69,
	...
	0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x32, 0x87, 0x02, 0x0a, 0x15, 0x44, 0x6f,
	0x75, 0x79, 0x69, 0x6e, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x7a, 0x0a, 0x06, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x28, 0x2e,
	...
	0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	0x72, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x26, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69,
	0x74, 0x65, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69,
	...
	0x69, 0x73, 0x74, 0x42, 0x29, 0x5a, 0x27, 0x6d, 0x69, 0x6e, 0x69, 0x2d, 0x54, 0x69, 0x6b, 0x74,
	0x6f, 0x6b, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x69, 0x6e, 0x74,
	0x65, 0x72, 0x61, 0x63, 0x74, 0x2f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65,
}
...
var file_favorite_proto_depIdxs = []int32{
	4, // 0: favorite.douyin_favorite_list_response.video_list:type_name -> common.Video
	0, // 1: favorite.DouyinFavoriteService.Action:input_type -> favorite.douyin_favorite_action_request
	2, // 2: favorite.DouyinFavoriteService.List:input_type -> favorite.douyin_favorite_list_request
	1, // 3: favorite.DouyinFavoriteService.Action:output_type -> favorite.douyin_favorite_action_response
	3, // 4: favorite.DouyinFavoriteService.List:output_type -> favorite.douyin_favorite_list_response
